...
import { 
  Code, Layout, Smartphone, Database, Quote, 
  ChevronLeft, ChevronRight, MessageSquareDashed, Users 
} from 'lucide-react';
  ...
  return (
    <section className="space-y-12">
      ...
      <header className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-8 border-b border-border pb-4">About Me</h2>
