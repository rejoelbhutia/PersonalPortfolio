...
const Sidebar = () => {
  return (
    <aside className="w-full min-h-full bg-sidebar rounded-3xl flex flex-col gap-y-4 p-6 shrink-0 border border-border/50 shadow-2xl">
        ...
        <div className="flex flex-col gap-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-sm text-white font-medium break-all">rejoelbhutia69@gmail.com</p>
            </div>
          </div>
